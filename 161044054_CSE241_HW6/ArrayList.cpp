...
namespace COLLECTION{
    ...
    ArrayList<E,container>::ArrayList()noexcept:List<E,container>(){ }

    //generate a new Iterator<E,container> and return this
    template<typename E,typename container>
    Iterator<E,container> ArrayList<E,container>::iterator()noexcept{ Iterator<E,container>it(Container); return it; }

    //adds the new e int Container via std::'s insert functions
    template<typename E,typename container>
    bool ArrayList<E,container>::add(E e)noexcept{
    ...
    template<typename E,typename container>
    bool ArrayList<E,container>::addAll(Collection<E,container>& c)throw(MyException){
        if(c.isEmpty()){
    ...
    template<typename E,typename container>
    void ArrayList<E,container>::clear()noexcept{ Container.clear(); }//Sıkıntı çıkarabilir

    //I use normal for loop and if equal to each other then I return the true statement
    template<typename E,typename container>
    bool ArrayList<E,container>::contains(E e)noexcept{
    ...
    template<typename E,typename container>
    bool ArrayList<E,container>::containsAll(Collection<E,container>& c)noexcept{
    ...
    template<typename E,typename container>
    bool ArrayList<E,container>::isEmpty()const noexcept{ return Container.empty(); }

    //I use the control all element and find with my iterator and remove this with std::'s erase function
    template<typename E,typename container>
    bool ArrayList<E,container>::remove(E e)throw(MyException){
        if(contains(e)){
            Iterator<E,container>itTemp(Container);
            for(int i=0;i<Container.size();++i){
                if(*itTemp.getIterator()==e){
    ...
    template<typename E,typename container>
    bool ArrayList<E,container>::removeAll(Collection<E,container>& c)throw(MyException){
        if(c.isEmpty()){
    ...
    template<typename E,typename container>
    bool ArrayList<E,container>::retainAll(Collection<E,container>& c)throw(MyException){
        if(c.isEmpty()==1){
    ...
    template<typename E,typename container>
    int ArrayList<E,container>::size()const noexcept{ return Container.size(); }

    template<typename E,typename container >
    container ArrayList<E,container>::getCont()const noexcept{ return Container; }

    //MY ADDED FUNCTIONS
    template<typename E,typename container >
    void ArrayList<E,container>::printAll() noexcept{
        if(isEmpty())
